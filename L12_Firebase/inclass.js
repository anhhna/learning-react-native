...
export default class l12_firebase extends Component {
  constructor(props){
    ...
    this.listeningForNumberOfUserOnline = this.listeningForNumberOfUserOnline.bind(this);
  ...
  handleAppStateChange(){
    ...
    if (AppState.currentState == 'active'){
      ...
      BackgroundTimer.setTimeout(()=>{
        this.getNumberOfUserOnlineOnceAndDecreaseBy1();
      },0);
    }
  }

  //Increase the userOnline by 1 in Firebase DB.
  getNumberOfUserOnlineOnceAndIncreaseBy1(){
    this.userOnlineRef.transaction(value => value+1);
  }

  //Decrease the userOnline by 1 in Firebase DB.
  getNumberOfUserOnlineOnceAndDecreaseBy1(){
    this.userOnlineRef.transaction(value => value-1);
  }
